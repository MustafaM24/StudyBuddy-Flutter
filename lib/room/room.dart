...
class Room extends StatelessWidget {
  ...
  TextEditingController roomusername = TextEditingController();
  TextEditingController roomemail = TextEditingController();
  TextEditingController roomname = TextEditingController();
  TextEditingController roompassword = TextEditingController();
  TextEditingController roomconfirmPassword = TextEditingController();
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      height: 45.0,
                      child: TextFormField(
                        controller: roomconfirmPassword,
                        decoration: const InputDecoration(
                          enabledBorder: OutlineInputBorder(
                              borderSide: BorderSide(
                                  color: Color(0xFF696d97), width: 1)),
